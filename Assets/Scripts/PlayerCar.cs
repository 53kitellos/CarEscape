...
public class PlayerCar : MonoBehaviour
{
    ...
    */
      ...
      float _spendNitroValue = -20;
      float _refillNirtoValue = 10;
    ...
    public void GoForward(int accelerationValue){
        ...
        else
      {
        if(Mathf.RoundToInt(carSpeed) < maxSpeed){
          ...
          frontLeftCollider.motorTorque = (accelerationValue * 50f) * throttleAxis;
          frontRightCollider.brakeTorque = 0;
          frontRightCollider.motorTorque = (accelerationValue * 50f) * throttleAxis;
          rearLeftCollider.brakeTorque = 0;
          rearLeftCollider.motorTorque = (accelerationValue * 50f) * throttleAxis;
          rearRightCollider.brakeTorque = 0;
          rearRightCollider.motorTorque = (accelerationValue * 50f) * throttleAxis;
        }
        else
        {
