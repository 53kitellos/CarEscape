...
public class CarEditor : Editor{
  ...
  private SerializedProperty nitroBar;
  ...
  private void OnEnable(){
    ...
    nitroBar = SO.FindProperty("nitroBar");
  ...
  public override void OnInspectorGUI(){
    ...
    GUILayout.Space(10);
        ...
        EditorGUILayout.PropertyField(nitroBar, new GUIContent("Nitro (UI): ")); 
